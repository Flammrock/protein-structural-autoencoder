...
public class WindowPanel extends AbstractComponent {
	...
	private Event.Manager eventManager;
	...
	public void setBindingOnDraw(Event.Callback c) {
		eventManager.register("draw", c);
	}
	
	public void setBindingOnClose(Event.Callback c) {
		eventManager.register("close", c);
	}
	
	public void setBindingOnOpen(Event.Callback c) {
